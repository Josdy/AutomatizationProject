...
public class TerminalType {
	...
	public void fixTerminalType(WebDriver driver, String TerminalType) {
		Actions action = new Actions(driver);
		WebElement elementLocator = driver.findElement(By.xpath("//div[contains(text(), '" + TerminalType + "')]"));
	...
	public void editTerminalType(WebDriver driver, String TerminalType) {
